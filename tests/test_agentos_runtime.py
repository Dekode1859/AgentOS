...
from agentos import agents, providers
from agentos.runtime import paths
from agentos.runtime.shell import _parse_multipart_files
...
def _multipart(*parts: tuple[str, str, str], boundary: str = "----AgentOSTest") -> bytes:
...
CT = "multipart/form-data; boundary=----AgentOSTest"
