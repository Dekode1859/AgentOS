"""
Command line entry point: ``agentos <command>`` (or ``python -m agentos``).

Provisioning only. AgentOS runs applications, not a CLI — this exists so the
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="agentos",
        description="AgentOS runtime — execution-engine provisioning.",
    )
