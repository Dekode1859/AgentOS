...
AgentOS is a deterministic runtime engine for executing AI-driven workflows defined entirely outside the core system. It is a runtime with a swappable core — not a framework, library, or template.

**Core invariant:** Replace the Core of any AgentOS app with the Core of another and both must still run unmodified. Delete any app and Core remains unchanged and functional.
